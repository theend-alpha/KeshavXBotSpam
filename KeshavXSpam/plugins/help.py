from KeshavXSpam import Mig, Mig2, Mig3, Mig4, Mig5, Mig6, Mig7, Mig8, Mig9, Mig10, SUDO_USERS
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
        ...
        Alert = (
                "Noob !! Make Your Own Keshav X Spam Bots !! @KeshavXSpam"
            )
